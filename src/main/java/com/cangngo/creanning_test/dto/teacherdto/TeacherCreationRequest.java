...
public class TeacherCreationRequest {
    ...
    public TeacherCreationRequest() {
    }

    public TeacherCreationRequest(String codeTeacher, String lastName, String firstName, String image, double salary, Date firstDayOfWork,String degree, String contract) {
